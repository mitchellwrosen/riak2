...
data Response :: Type where
  RespRpbError             :: Proto.RpbErrorResp             -> Response
  RespRpbPing              :: Proto.RpbPingResp              -> Response
  RespRpbGetServerInfo     :: Proto.RpbGetServerInfoResp     -> Response
  RespRpbGet               :: Proto.RpbGetResp               -> Response
  RespRpbPut               :: Proto.RpbPutResp               -> Response
  RespRpbDel               :: Proto.RpbDelResp               -> Response
  RespRpbListBuckets       :: Proto.RpbListBucketsResp       -> Response
  RespRpbListKeys          :: Proto.RpbListKeysResp          -> Response
  RespRpbGetBucket         :: Proto.RpbGetBucketResp         -> Response
  RespRpbSetBucket         :: Proto.RpbSetBucketResp         -> Response
  RespRpbMapRed            :: Proto.RpbMapRedResp            -> Response
  RespRpbIndex             :: Proto.RpbIndexResp             -> Response
  RespRpbSearchQuery       :: Proto.RpbSearchQueryResp       -> Response
  RespRpbResetBucket       :: Proto.RpbResetBucketResp       -> Response
  RespRpbYokozunaIndexGet  :: Proto.RpbYokozunaIndexGetResp  -> Response
  RespRpbYokozunaSchemaGet :: Proto.RpbYokozunaSchemaGetResp -> Response
  RespDtFetch              :: Proto.DtFetchResp              -> Response
  RespDtUpdate             :: Proto.DtUpdateResp             -> Response
  deriving stock (Eq, Show)
