...
instance Functor f => HasLens' f (Content a)             "type'"    (BucketType 'Nothing)   where lensOf' _ = lens (\(Content x _ _ _ _ _ _ _ _ _) -> x) (\(Content _ b c d e f g h i j) x -> Content x b c d e f g h i j)
